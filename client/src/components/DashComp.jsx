...
import { HiArrowNarrowUp, HiDocument, HiDocumentText, HiOutlineAnnotation, HiOutlineUserGroup } from 'react-icons/hi'
                        ...
                        {users && users.map(user => (
                            <Table.Body className='divide-y'>
                                <Table.Row className='bg-white dark:border-gray-700'>
                                    <Table.Cell>
                                        <img className='w-10 h-10 rounded-full bg-gray-500' src={user.profilePicture} alt="" />
                                    </Table.Cell>
                    ...
                    <Table hoverable>
                        ...
                        {posts && posts.map(post => (
                            <Table.Body className='divide-y'>
                                <Table.Row className='bg-white dark:border-gray-700'>
                                    <Table.Cell>
                                        <img className='w-14 h-10 bg-gray-500' src={post.image} alt="" />
                                    </Table.Cell>
